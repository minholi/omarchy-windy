...
assert.match(panel, /heroCaptionText/);
assert.match(panel, /text:\s*root\.heroCaptionText/);
assert.ok(!panel.includes('"FEELS LIKE"'), 'the caption under the feels-like value shows the air temperature');
