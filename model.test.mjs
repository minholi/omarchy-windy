...
assert.match(panel, /heroShowsFeels/);
assert.match(panel, /secondaryTemperatureLabel/);
assert.match(panel, /secondaryTemperatureValue/);
assert.match(panel, /text:\s*root\.secondaryTemperatureLabel/);
assert.match(panel, /text:\s*root\.secondaryTemperatureValue/);
assert.ok(!panel.includes('"FEELS LIKE"'), 'the header has no feels-like caption');
